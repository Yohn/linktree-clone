						...
						<div class="row d-flex justify-content-center align-items-center">
							...
							<div class="row col-lg-8 col-md-6 justify-content-between">
								...
								<div class="align-self-lg-end form-group">
									<label for="about_notes">Info</label>
									<textarea id="about_notes"
										class="form-control {{ $errors->first('about_notes') ? 'is-invalid' : '' }}"
										name="about_notes" placeholder="Notes that appear on your profile">
										{{ old('about_notes') ? old('about_notes') : $user->about_notes }}
									</textarea>

									@if ($errors->first('about_notes'))
									<span class="invalid-feedback" role="alert">
